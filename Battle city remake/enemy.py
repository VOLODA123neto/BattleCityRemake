...
class Enemy:
    def __init__(self, x, y):
        ...
        self.textures = {
            "UP": pygame.image.load("assets/enemy_up.png"),
            "DOWN": pygame.image.load("assets/enemy_down.png"),
            "LEFT": pygame.image.load("assets/enemy_left.png"),
            "RIGHT": pygame.image.load("assets/enemy_right.png"),
        }
